...
Locatie cafe = new Locatie("Cafe", 5);
Locatie restaurant = new Locatie("Restaurant", 8);
//Locatie bar = new Locatie("Bar", 2, 3);
Locatie terras = new Locatie("Terras", 20);
...
@Test
    ...
    if (Persoon.getAantalPersonen() >= Locatie.getMaxAantalPersonen()) {
